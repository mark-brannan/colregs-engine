...
| FIND-02 | consistency-conflicting-shall | 114048 | entries 26c-id and 30a are both resolved 'shall' and rel:excludes the other: a conflicting obligation | 26(c)(i); 30(a) | human-reviewed | Same ruling as FIND-01; the fishing (26(c)) + anchored case is the real one, resolved by rel:overrides. |
| FIND-03 | consistency-no-obligation | 114048 | record has zero applied lights entries and so no lawful display, for a vessel with fact:position = position:moored | - | triaged | Agent read: correct gap, position:moored is Rule 3(i)'s shore-fast case, which prescribes no lights; see issue #24. Awaiting Mark's ruling on whether moored is split, removed, or out of scope. |
