...
export function buildEncoding(data: ApplicabilityData): Encoding {
  ...
  lines.push(';; Written to research/z3/out/ by `npm run z3` (gitignored: it is a
;; function of the pinned colregs, not a source file). Hand it to any
;; SMT-LIB 2 solver as-is.');
  lines.push(';;');
